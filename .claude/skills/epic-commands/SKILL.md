...
execute unattended. The canonical extended reference is `node_modules/@joshuafolkken/kit/prompts/collaboration-workflow/` — `epic-bundle.md`, `epic-plan.md`, `epic-audit.md` and `cross-repo-epic.md` between them; this
