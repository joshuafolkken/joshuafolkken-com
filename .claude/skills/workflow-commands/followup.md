...
See `node_modules/@joshuafolkken/kit/prompts/collaboration-workflow/operating-rules.md` → "Auto-merge（default for `fullrun`）" for the portable, cross-AI version of this rule.
